...
<head>
    ...
    <title>ICT specialists E-market</title>
    ...
    <link rel="icon" href="http://www.sydotech.com/img/logo/logo.png">
</head><!--/head-->
          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> 0393 225 735</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> ictspecialistsug@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="social-icons pull-right">
              <ul class="nav navbar-nav">
                ...
                <li><a href="https://www.linkedin.com/feed/?trk=guest_homepage-basic_nav-header-signin" target="_blank"><i class="fa fa-linkedin"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="http://localhost/ecommerce/admin/login.php?logout=1"><i class="fa-solid fa-gear"></i>admin</a></li>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#">ict specialists</a></li>
                <li><a href="#">Plot 9/11 Adumi Road OB Plaza</a></li>
          ...
          <div class="col-sm-4">
            <div class="single-widget">
              <h2>About us</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="#">ictspecialists@gmail.Com</a></li>
                <li><a href="#"> ict specialists </a></li>
                <li><a href="">+256 773391127</a></li>
