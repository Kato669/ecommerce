      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>UgShs: <?php echo  $result->PRODISPRICE ?></td>
                          <td>UgShs: <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
                        </tr>
              <?php
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p align="right">
                  <div > Total Price :   UgShs: <span id="sum">0.00</span></div>
                   <div > Delivery Fee : UgShs: <span id="fee">0.00</span></div>
                   <div> Overall Price : UgShs: <span id="overall"><?php echo $tot ;?></span></div>
